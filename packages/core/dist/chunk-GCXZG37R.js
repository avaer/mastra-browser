import { TABLE_TRACES } from './chunk-FAAZLQT5.js';
...
var _OTLPTraceExporter = class _OTLPTraceExporter {
  constructor({ logger, storage }) {
    ...
    __publicField(this, "activeFlush");
  ...
  traceMethod(method, context3) {
    ...
    return (...args) => {
      ...
      try {
        ...
        __name(recordResult2, "recordResult");
