...
var _BaseFilterTranslator = class _BaseFilterTranslator {
  /**
...
chunk7D636BPD_cjs.__name(_BaseFilterTranslator, "BaseFilterTranslator");
chunk7D636BPD_cjs.__publicField(_BaseFilterTranslator, "BASIC_OPERATORS", ["$eq", "$ne"]);
chunk7D636BPD_cjs.__publicField(_BaseFilterTranslator, "NUMERIC_OPERATORS", ["$gt", "$gte", "$lt", "$lte"]);
chunk7D636BPD_cjs.__publicField(_BaseFilterTranslator, "ARRAY_OPERATORS", ["$in", "$nin", "$all", "$elemMatch"]);
chunk7D636BPD_cjs.__publicField(_BaseFilterTranslator, "LOGICAL_OPERATORS", ["$and", "$or", "$not", "$nor"]);
chunk7D636BPD_cjs.__publicField(_BaseFilterTranslator, "ELEMENT_OPERATORS", ["$exists"]);
chunk7D636BPD_cjs.__publicField(_BaseFilterTranslator, "REGEX_OPERATORS", ["$regex", "$options"]);
chunk7D636BPD_cjs.__publicField(_BaseFilterTranslator, "DEFAULT_OPERATORS", {
...
chunk7D636BPD_cjs.__publicField(_BaseFilterTranslator, "ErrorMessages", {
  UNSUPPORTED_OPERATOR: /* @__PURE__ */ chunk7D636BPD_cjs.__name((op) => `Unsupported operator: ${op}`, "UNSUPPORTED_OPERATOR"),
  INVALID_LOGICAL_OPERATOR_LOCATION: /* @__PURE__ */ chunk7D636BPD_cjs.__name((op, path) => `Logical operator ${op} cannot be used at field level: ${path}`, "INVALID_LOGICAL_OPERATOR_LOCATION"),
  NOT_REQUIRES_OBJECT: `$not operator requires an object`,
  NOT_CANNOT_BE_EMPTY: `$not operator cannot be empty`,
  INVALID_LOGICAL_OPERATOR_CONTENT: /* @__PURE__ */ chunk7D636BPD_cjs.__name((path) => `Logical operators must contain field conditions, not direct operators: ${path}`, "INVALID_LOGICAL_OPERATOR_CONTENT"),
  INVALID_TOP_LEVEL_OPERATOR: /* @__PURE__ */ chunk7D636BPD_cjs.__name((op) => `Invalid top-level operator: ${op}`, "INVALID_TOP_LEVEL_OPERATOR"),
  ELEM_MATCH_REQUIRES_OBJECT: `$elemMatch requires an object with conditions`
});
var BaseFilterTranslator = _BaseFilterTranslator;

exports.BaseFilterTranslator = BaseFilterTranslator;
//# sourceMappingURL=chunk-NXHJJ76H.cjs.map
//# sourceMappingURL=chunk-NXHJJ76H.cjs.map