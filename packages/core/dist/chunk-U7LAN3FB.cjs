...
var MastraLLMBase = class extends chunkUV2QUUKW_cjs.MastraBase {
  // @ts-ignore
  #mastra;
  #model;
  constructor({
...
_Agent_decorators = [chunkEDBJG533_cjs.InstrumentClass({
  prefix: "agent",
  excludeMethods: ["__setTools", "__setLogger", "__setTelemetry", "log"]
})];
exports.Agent = class Agent extends (_a = chunkUV2QUUKW_cjs.MastraBase) {
  name;
  llm;
  instructions;
  model;
  ...
  constructor(config) {
    super({
      component: chunkCGUKSEPG_cjs.RegisteredLogger.AGENT
    });
