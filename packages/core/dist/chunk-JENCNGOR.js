...
var _MastraLLM = class _MastraLLM extends MastraLLMBase {
  ...
  getModel() {
    return __privateGet(this, _model2);
  }
  convertTools({
    tools,
    runId,
...
var _Agent = class _Agent extends (_a = MastraBase) {
  constructor(config) {
    super({
  ...
  async generate(messages, {
    ...
    if (!output && experimental_output) {
      const result2 = await this.llm.__text({
        ...
        tools: this.tools,
        convertedTools,
        onStepFinish: /* @__PURE__ */__name(result3 => {
    ...
    const result = await this.llm.__textObject({
      ...
      structuredOutput: output,
      convertedTools,
      onStepFinish: /* @__PURE__ */__name(result2 => {
  ...
  async stream(messages, {
    ...
    if (!output && experimental_output) {
      ...
      const streamResult = await this.llm.__stream({
        ...
        tools: this.tools,
        convertedTools,
        onStepFinish: /* @__PURE__ */__name(result => {
...
_Agent = /*@__PURE__*/(_ => {
  _memory = new WeakMap();
  _Agent = __decorateElement(_init, 0, "Agent", _Agent_decorators, _Agent);
  __name(_Agent, "Agent");
  return _Agent;
})();
__runInitializers(_init, 1, _Agent);
var Agent = _Agent;

export { Agent };
//# sourceMappingURL=chunk-JENCNGOR.js.map
//# sourceMappingURL=chunk-JENCNGOR.js.map