...
var delay = /* @__PURE__ */ chunk7D636BPD_cjs.__name((ms) => new Promise((resolve) => setTimeout(resolve, ms)), "delay");
...
chunk7D636BPD_cjs.__name(jsonSchemaPropertiesToTSTypes, "jsonSchemaPropertiesToTSTypes");
...
chunk7D636BPD_cjs.__name(jsonSchemaToModel, "jsonSchemaToModel");
...
chunk7D636BPD_cjs.__name(deepMerge, "deepMerge");
async function* maskStreamTags(stream, tag, options = {}) {
  ...
  const trimOutsideDelimiter = /* @__PURE__ */ chunk7D636BPD_cjs.__name((text, delimiter, trim) => {
  ...
  }, "trimOutsideDelimiter");
  const startsWith = /* @__PURE__ */ chunk7D636BPD_cjs.__name((text, pattern) => {
...
chunk7D636BPD_cjs.__name(maskStreamTags, "maskStreamTags");
...
chunk7D636BPD_cjs.__name(createLogMessageOptions, "createLogMessageOptions");
function createExecute(tool, options, logType) {
  ...
  const execFunction = /* @__PURE__ */ chunk7D636BPD_cjs.__name(async (args, execOptions) => {
...
chunk7D636BPD_cjs.__name(createExecute, "createExecute");
function isZodType(value) {
  return typeof value === "object" && value !== null && "_def" in value && "parse" in value && typeof value.parse === "function" && "safeParse" in value && typeof value.safeParse === "function";
}
chunk7D636BPD_cjs.__name(isZodType, "isZodType");
function createDeterministicId(input) {
  return crypto.createHash("sha256").update(input).digest("hex").slice(0, 8);
}
chunk7D636BPD_cjs.__name(createDeterministicId, "createDeterministicId");
...
chunk7D636BPD_cjs.__name(setVercelToolProperties, "setVercelToolProperties");
...
chunk7D636BPD_cjs.__name(ensureToolProperties, "ensureToolProperties");
...
chunk7D636BPD_cjs.__name(convertVercelToolParameters, "convertVercelToolParameters");
function makeCoreTool(tool, options, logType) {
  const getParameters = /* @__PURE__ */ chunk7D636BPD_cjs.__name(() => {
    if (isVercelTool(tool)) {
...
chunk7D636BPD_cjs.__name(makeCoreTool, "makeCoreTool");
...
chunk7D636BPD_cjs.__name(createMastraProxy, "createMastraProxy");
...
chunk7D636BPD_cjs.__name(checkEvalStorageFields, "checkEvalStorageFields");
...
chunk7D636BPD_cjs.__name(detectSingleMessageCharacteristics, "detectSingleMessageCharacteristics");
function isUiMessage(message) {
  return detectSingleMessageCharacteristics(message) === `has-ui-specific-parts`;
}
chunk7D636BPD_cjs.__name(isUiMessage, "isUiMessage");
function isCoreMessage(message) {
  return [`has-core-specific-parts`, `message`].includes(detectSingleMessageCharacteristics(message));
}
chunk7D636BPD_cjs.__name(isCoreMessage, "isCoreMessage");
...
chunk7D636BPD_cjs.__name(ensureAllMessagesAreCoreMessages, "ensureAllMessagesAreCoreMessages");
