...
async function* maskStreamTags(stream, tag, options = {}) {
  ...
  const trimOutsideDelimiter = /* @__PURE__ */ __name((text, delimiter, trim) => {
  ...
  const startsWith = /* @__PURE__ */ __name((text, pattern) => {
...
__name(createLogMessageOptions, "createLogMessageOptions");
...
__name(createExecute, "createExecute");
...
function makeCoreTool(tool, options, logType) {
  const getParameters = /* @__PURE__ */ __name(() => {
    if (isVercelTool(tool)) {
...
__name(checkEvalStorageFields, "checkEvalStorageFields");
