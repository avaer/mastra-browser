...
// ../../node_modules/.pnpm/@electric-sql+pglite@0.2.17/node_modules/@electric-sql/pglite/dist/chunk-BTBUZ646.js
var p = Object.create;
...
var a = /* @__PURE__ */ chunk7D636BPD_cjs.__name((t) => {
  throw TypeError(t);
}, "a");
var _ = /* @__PURE__ */ chunk7D636BPD_cjs.__name((t, e, o) => e in t ? i(t, e, { enumerable: true, configurable: true, writable: true, value: o }) : t[e] = o, "_");
var d = /* @__PURE__ */ chunk7D636BPD_cjs.__name((t, e) => () => (t && (e = t(t = 0)), e), "d");
var D = /* @__PURE__ */ chunk7D636BPD_cjs.__name((t, e) => () => (e || t((e = { exports: {} }).exports, e), e.exports), "D");
var F = /* @__PURE__ */ chunk7D636BPD_cjs.__name((t, e) => {
  for (var o in e) i(t, o, { get: e[o], enumerable: true });
}, "F");
var g = /* @__PURE__ */ chunk7D636BPD_cjs.__name((t, e, o, m) => {
  if (e && typeof e == "object" || typeof e == "function") for (let r of f(e)) !s.call(t, r) && r !== o && i(t, r, { get: /* @__PURE__ */ chunk7D636BPD_cjs.__name(() => e[r], "get"), enumerable: !(m = c(e, r)) || m.enumerable });
  return t;
}, "g");
var L = /* @__PURE__ */ chunk7D636BPD_cjs.__name((t, e, o) => (o = t != null ? p(l(t)) : {}, g(e || !t || !t.__esModule ? i(o, "default", { value: t, enumerable: true }) : o, t)), "L");
var P = /* @__PURE__ */ chunk7D636BPD_cjs.__name((t, e, o) => _(t, typeof e != "symbol" ? e + "" : e, o), "P");
var n = /* @__PURE__ */ chunk7D636BPD_cjs.__name((t, e, o) => e.has(t) || a("Cannot " + o), "n");
var h = /* @__PURE__ */ chunk7D636BPD_cjs.__name((t, e, o) => (n(t, e, "read from private field"), o ? o.call(t) : e.get(t)), "h");
var R = /* @__PURE__ */ chunk7D636BPD_cjs.__name((t, e, o) => e.has(t) ? a("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, o), "R");
var x = /* @__PURE__ */ chunk7D636BPD_cjs.__name((t, e, o, m) => (n(t, e, "write to private field"), m ? m.call(t, o) : e.set(t, o), o), "x");
var T = /* @__PURE__ */ chunk7D636BPD_cjs.__name((t, e, o) => (n(t, e, "access private method"), o), "T");
var U = /* @__PURE__ */ chunk7D636BPD_cjs.__name((t, e, o, m) => ({ set _(r) {
  x(t, e, r, o);
}, get _() {
  return h(t, e, m);
} }), "U");
...
// ../../node_modules/.pnpm/@electric-sql+pglite@0.2.17/node_modules/@electric-sql/pglite/dist/chunk-WGR4JCLS.js
var w = D(($r, l2) => {
  u();
  ...
  chunk7D636BPD_cjs.__name(mr, "mr");
  function q(r) {
    return typeof r == "string" || Object.prototype.toString.call(r) == "[object String]";
  }
  chunk7D636BPD_cjs.__name(q, "q");
  function lr(r) {
    return Object.prototype.toString.call(r) == "[object Date]";
  }
  chunk7D636BPD_cjs.__name(lr, "lr");
  function N(r) {
    return r !== null && typeof r == "object";
  }
  chunk7D636BPD_cjs.__name(N, "N");
  function U2(r) {
    return typeof r == "function";
  }
  chunk7D636BPD_cjs.__name(U2, "U");
  function fr(r) {
    return typeof r == "number" && r > -1 && r % 1 == 0 && r <= j;
  }
  chunk7D636BPD_cjs.__name(fr, "fr");
  function yr(r) {
    return Object.prototype.toString.call(r) == "[object Array]";
  }
  chunk7D636BPD_cjs.__name(yr, "yr");
  function Y(r) {
    return N(r) && !U2(r) && fr(r.length);
  }
  chunk7D636BPD_cjs.__name(Y, "Y");
  function D2(r) {
    return Object.prototype.toString.call(r) == "[object ArrayBuffer]";
  }
  chunk7D636BPD_cjs.__name(D2, "D");
  function gr(r, e) {
    return Array.prototype.map.call(r, e);
  }
  chunk7D636BPD_cjs.__name(gr, "gr");
  function hr(r, e) {
    var t = B;
  ...
  chunk7D636BPD_cjs.__name(hr, "hr");
  function Sr(r) {
    return Object.assign.apply(null, arguments);
  }
  chunk7D636BPD_cjs.__name(Sr, "Sr");
  function W(r) {
    var e, t, s2;
    if (q(r)) {
...
var L2 = D((ee, f2) => {
  ...
  chunk7D636BPD_cjs.__name(Tr, "Tr");
...
var er = D((ne, rr) => {
  ...
  chunk7D636BPD_cjs.__name(Er, "Er");
  function Pr(r, e, t) {
    t = parseInt(t) || 0;
    var s2 = t;
  ...
  chunk7D636BPD_cjs.__name(Pr, "Pr");
  function wr(r, e, t) {
    return t = parseInt(t, 10) || 0, r.set(e.data, t), t + Q(e);
  }
  chunk7D636BPD_cjs.__name(wr, "wr");
  function xr(r) {
  ...
  chunk7D636BPD_cjs.__name(xr, "xr");
  rr.exports.tar = xr;
});
var nr = D((oe, tr) => {
  u();
  ...
  chunk7D636BPD_cjs.__name(Ir, "Ir");
  tr.exports.untar = Ir;
});
var or = D((se, ir) => {
  u();
...
chunk7D636BPD_cjs.__name(ce, "ce");
function jr(r, e) {
  let t = [], s2 = /* @__PURE__ */ chunk7D636BPD_cjs.__name((a2) => {
...
chunk7D636BPD_cjs.__name(jr, "jr");
function Br(r, e) {
  let t = jr(r, e);
  return (0, g2.tar)(t);
}
...
chunk7D636BPD_cjs.__name(qr, "qr");
async function Yr(r) {
...
chunk7D636BPD_cjs.__name(ar, "ar");
async function Xr(r) {
...
}, chunk7D636BPD_cjs.__name(_a, "ur"), _a);
var _a2;
var cr = (_a2 = class {
...
exports.ur = ur;
exports.x = x;
//# sourceMappingURL=chunk-2HHGZRYW.cjs.map
//# sourceMappingURL=chunk-2HHGZRYW.cjs.map