...
__name(_BaseFilterTranslator, "BaseFilterTranslator");
__publicField(_BaseFilterTranslator, "BASIC_OPERATORS", ["$eq", "$ne"]);
__publicField(_BaseFilterTranslator, "NUMERIC_OPERATORS", ["$gt", "$gte", "$lt", "$lte"]);
__publicField(_BaseFilterTranslator, "ARRAY_OPERATORS", ["$in", "$nin", "$all", "$elemMatch"]);
__publicField(_BaseFilterTranslator, "LOGICAL_OPERATORS", ["$and", "$or", "$not", "$nor"]);
__publicField(_BaseFilterTranslator, "ELEMENT_OPERATORS", ["$exists"]);
__publicField(_BaseFilterTranslator, "REGEX_OPERATORS", ["$regex", "$options"]);
__publicField(_BaseFilterTranslator, "DEFAULT_OPERATORS", {
...
__publicField(_BaseFilterTranslator, "ErrorMessages", {
...
//# sourceMappingURL=chunk-W3JW2AUS.js.map
//# sourceMappingURL=chunk-W3JW2AUS.js.map