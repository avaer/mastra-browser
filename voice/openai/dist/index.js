...
var OpenAIVoice = class extends MastraVoice {
  ...
  constructor({
    ...
    this.speechClient = speechBaseURL && speechApiKey ? new OpenAI({ apiKey: speechApiKey, baseURL: speechBaseURL, dangerouslyAllowBrowser: true }) : void 0;
    ...
    this.listeningClient = listeningBaseURL && listeningApiKey ? new OpenAI({ apiKey: listeningApiKey, baseURL: listeningBaseURL, dangerouslyAllowBrowser: true }) : void 0;
